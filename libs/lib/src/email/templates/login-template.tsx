...
import { LoginEmailTemplate } from '../dto';

const baseUrl = process.env.APP_URL ? `https://${process.env.APP_URL}` : '';

export const LoginComponent = (props: Omit<LoginEmailTemplate, 'template'>) => (
  <Html>
    <Head />
      ...
      <Container style={container}>
        ...
        <Section>
          <Text style={cupomText}>
            Hello {props.firstName} Save 3% on all your Apple purchases with
            Apple Card.
